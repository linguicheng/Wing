import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{r as o,o as p,c as i,a as s,b as n,d as e,e as l}from"./app-39aba6fa.js";const c="/wing/assets/3.4-1-f4429a9d.png",r={},u=l(`<h3 id="简介" tabindex="-1"><a class="header-anchor" href="#简介" aria-hidden="true">#</a> 简介</h3><p><code>Wing</code>的服务网关支持自定义请求路由配置。</p><h3 id="自定义路由配置示例" tabindex="-1"><a class="header-anchor" href="#自定义路由配置示例" aria-hidden="true">#</a> 自定义路由配置示例</h3><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
