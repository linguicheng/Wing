import{_ as u}from"./plugin-vue_export-helper-c27b6911.js";import{r as l,o as r,c as d,a as n,b as s,d as p,w as a,e as o}from"./app-4687bc4a.js";const k="/Wing/assets/3.3-1-05289da2.png",v="/Wing/assets/3.3-2-07a89789.png",b={},m=o('<h3 id="简介" tabindex="-1"><a class="header-anchor" href="#简介" aria-hidden="true">#</a> 简介</h3><p><code>Wing</code>的服务网关支持<code>WebSocket</code>请求的转发，同时支持<code>Wing</code>服务的所有负载均衡算法。</p><h3 id="状态码说明" tabindex="-1"><a class="header-anchor" href="#状态码说明" aria-hidden="true">#</a> 状态码说明</h3><ul><li><p><strong>1001</strong> 找不到下游服务</p></li><li><p><strong>1008</strong> 权限认证不通过</p></li><li><p><strong>1011</strong> 网关或服务异常</p></li></ul><h3 id="创建一个支持websocket的网关" tabindex="-1"><a class="header-anchor" href="#创建一个支持websocket的网关" aria-hidden="true">#</a> 创建一个支持WebSocket的网关</h3>',5),g=n("li",null,[n("p",null,"提前准备：安装并启动Consul")],-1),h={href:"https://gitee.com/linguicheng/wing-demo/tree/master/3.3-1",target:"_blank",rel:"noopener noreferrer"},q=n("h3",{id:"安装依赖包",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#安装依赖包","aria-hidden":"true"},"#"),s(" 安装依赖包")],-1),y=n("div",{class:"language-bash line-numbers-mode","data-ext":"sh"},[n("pre",{class:"language-bash"},[n("code",null,[s("dotnet "),n("span",{class:"token function"},"add"),s(` package Wing.Consul

dotnet `),n("span",{class:"token function"},"add"),s(` package Wing.Gateway
`)])]),n("div",{class:"line-numbers","aria-hidden":"true"},[n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"})])],-1),f=n("div",{class:"language-bash line-numbers-mode","data-ext":"sh"},[n("pre",{class:"language-bash"},[n("code",null,`Install-Package Wing.Consul

Install-Package Wing.Gateway
`)]),n("div",{class:"line-numbers","aria-hidden":"true"},[n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"})])],-1),w=o(`<h3 id="program代码" tabindex="-1"><a class="header-anchor" href="#program代码" aria-hidden="true">#</a> Program代码</h3><div class="language-csharp line-numbers-mode" data-ext="cs"><pre class="language-csharp"><code><span class="token keyword">using</span> <span class="token namespace">Wing</span><span class="token punctuation">;</span>
