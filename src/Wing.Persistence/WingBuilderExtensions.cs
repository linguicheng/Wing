...
namespace Wing
{
    ...
    {
        public static IWingServiceBuilder AddPersistence(this IWingServiceBuilder wingBuilder, DataType dataType, string connectionString = "")
        {
            Builder.Add(wingBuilder.Services, (conn, autoSyncStructure) =>
            {
                var fsql = new FreeSqlBuilder()
                           .UseConnectionString(dataType, conn)
