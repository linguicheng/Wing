    ...
    public class DateTimeConverter : DateTimeConverterBase
    {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            if (CanConvert(objectType))
            {
                ...
                return new DateTime(greenwichMeanTime.Ticks + (SysConvert.ToInt64(reader.Value) * ratio)).ToLocalTime();
            }
        ...
        public override void WriteJson(JsonWriter writer, object value, JsonSerializer serializer)
        {
            ...
            {
                DateTime dt = SysConvert.ToDateTime(value);
                val = (dt.ToUniversalTime().Ticks - greenwichMeanTime.Ticks) / 10000000;
            }
            else
            {
                val = SysConvert.ToInt64(value);
            }
